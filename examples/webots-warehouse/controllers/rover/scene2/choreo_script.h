/*
 * choreo_script.h — GENERATED from scene2-partition.choreo.toml — DO NOT EDIT.
 *
 * Choreo: "wh-partition"
 * Regenerate after editing the script file:
 *   python3 tapestry/sdk/tools/choreoc.py tapestry/examples/webots-warehouse/scene2-partition.choreo.toml -o tapestry/examples/webots-warehouse/controllers/rover/scene2/choreo_script.h
 *
...
#define CHOREO_NAME                    "wh-partition"
#define CHOREO_SCRIPT_LEN              6u
#define CHOREO_SCRIPT_TOTAL_TIMEOUT_MS 210000u
